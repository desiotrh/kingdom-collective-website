...
const SocialMediaManagementScreen: React.FC = () => {
    ...
    // Mock platforms for Kingdom Voice (podcasting-focused)
    const supportedPlatforms = [
        { id: 'spotify', name: 'Spotify', icon: '🎵', color: '#1DB954' },
        { id: 'apple-podcasts', name: 'Apple Podcasts', icon: '🍎', color: '#FF6B6B' },
    ...
    const handleAddAccount = async (platformId: string, authData: any) => {
        try {
            const newAccount: SocialMediaAccount = {
                ...
                username: authData.username || `@voice_${platformId}`,
                ...
                <BlurView intensity={20} style={styles.modalContent}>
                    ...
                    <View style={styles.modalBody}>
                        <Text style={styles.modalDescription}>
                            {faithMode
                                ? `Connect your ${selectedPlatform?.name} account to share your voice and testimony with the world.`
                                : `Connect your ${selectedPlatform?.name} account to share your content and grow your audience.`
                            }
                        </Text>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                ...
                                handleAddAccount(selectedPlatform!.id, {
                                    username: `@voice_${selectedPlatform!.id}`,
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerTitle}>
                        {faithMode ? 'Social Media Hub' : 'Platform Management'}
                    </Text>
                    <Text style={styles.headerSubtitle}>
                        {faithMode
                            ? 'Connect your platforms to share your voice and testimony'
                            : 'Manage your social media accounts for content distribution'
                        }
                    </Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    {platforms.filter(p => p.isConnected).length === 0 ? (
                        <View style={styles.emptyState}>
                            <Ionicons name="share-social" size={48} color="#666" />
                            <Text style={styles.emptyStateText}>
                                No platforms connected yet. Connect a platform to start sharing your voice!
                            </Text>
                        </View>
                    ) : (

...
const SocialMediaManagementScreen: React.FC = () => {
    ...
    // Mock platforms for Kingdom Circle (community-focused)
    const supportedPlatforms = [
        ...
        { id: 'email', name: 'Email Groups', icon: '📧', color: '#EA4335' },
    ...
    const handleAddAccount = async (platformId: string, authData: any) => {
        try {
            const newAccount: SocialMediaAccount = {
                ...
                username: authData.username || `@circle_${platformId}`,
                ...
                <BlurView intensity={20} style={styles.modalContent}>
                    ...
                    <View style={styles.modalBody}>
                        <Text style={styles.modalDescription}>
                            {faithMode
                                ? `Connect your ${selectedPlatform?.name} account to build your Kingdom community and disciple others.`
                                : `Connect your ${selectedPlatform?.name} account to build your community and connect with others.`
                            }
                        </Text>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                ...
                                handleAddAccount(selectedPlatform!.id, {
                                    username: `@circle_${selectedPlatform!.id}`,
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerTitle}>
                        {faithMode ? 'Kingdom Community Hub' : 'Community Hub'}
                    </Text>
                    <Text style={styles.headerSubtitle}>
                        {faithMode
                            ? 'Connect your platforms to build your Kingdom community and disciple others'
                            : 'Manage your social media accounts for community building and connection'
                        }
                    </Text>
                </View>
                    ...
                    {platforms.filter(p => p.isConnected).length === 0 ? (
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyStateText}>
                                No platforms connected yet. Connect a platform to start building your community!
                            </Text>
                        </View>
                    ) : (

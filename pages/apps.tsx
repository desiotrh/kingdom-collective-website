      ...
      <div className="layout-container flex h-full grow flex-col relative z-10">
        ...
        <section className="px-40 py-20 bg-black/30 backdrop-blur-sm">
          <div className="max-w-[960px] mx-auto text-center">
            ...
            <p className="text-white text-xl leading-relaxed max-w-3xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-white text-xl font-bold mb-3">Cross-Platform Sync</h3>
                <p className="text-white">Content and data sync seamlessly across all your Kingdom apps.</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">👥</div>
                <h3 className="text-white text-xl font-bold mb-3">Unified Community</h3>
                <p className="text-white">One community, multiple touchpoints across all your platforms.</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">📊</div>
                <h3 className="text-white text-xl font-bold mb-3">Centralized Analytics</h3>
                <p className="text-white">Track your impact across all platforms from one dashboard.</p>
              </div>
            </div>
          </div>
        </section>

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Educational content delivery with interactive learning experiences. Master any subject with AI-powered personalized learning." />
      </Head>
            ...
            <section className="relative py-20 px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto text-center">
                ...
                <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto">
                  Educational content delivery with interactive learning experiences. 

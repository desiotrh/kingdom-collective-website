...
export default function OnboardingBot() {
  ...
  const handleDemoSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setAvgTimeToComplete(prev => Math.max(1, prev + selectedResponse.time));
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Streamlined user onboarding with personalized guidance and tutorials. Create exceptional user experiences with intelligent onboarding automation." />
      </Head>
            ...
            <section className="relative py-20 px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto text-center">
                ...
                <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto">
                  Streamlined user onboarding with personalized guidance and tutorials. 
                  Create exceptional user experiences with intelligent automation.
                </p>
